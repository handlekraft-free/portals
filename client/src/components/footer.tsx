      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          <Link href="/" className="flex items-center gap-3 mb-6 cursor-pointer">
            <img src={logoImg} alt="The Buddy Promise logo" className="w-10 h-10 rounded-lg" />
          ...
          <p className="max-w-md text-sm leading-relaxed mb-8 text-white/40">
            Founded by a father-son team. Powered by kindness, code, and community.
          </p>
          <div className="flex gap-4">
            ...
            <a href="mailto:hello@thebuddypromise.org" className="p-2 bg-white/5 rounded-full hover:bg-[#14B8A6] hover:text-[#0B1D3A] transition-colors"><Mail size={18} /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li><a href="#mission" className="hover:text-[#14B8A6] transition-colors">Our Promise</a></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li><a href="mailto:hello@thebuddypromise.org" className="hover:text-[#14B8A6] transition-colors">hello@thebuddypromise.org</a></li>
            <li>San Francisco, CA</li>
            <li className="pt-4 text-xs opacity-50">
              &copy; {new Date().getFullYear()} The Buddy Promise. All rights reserved.
            </li>
          </ul>
        </div>
      </div>
