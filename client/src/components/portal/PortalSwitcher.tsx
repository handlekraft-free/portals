...
const PORTAL_META: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
  ...
  employee: { label: "Team Portal",   icon: <Briefcase className="w-3.5 h-3.5" />,     color: "#0D7377" },
  client:   { label: "Client Portal", icon: <Building2 className="w-3.5 h-3.5" />,     color: "#D4A843" },
  student:  { label: "Fellow Portal", icon: <GraduationCap className="w-3.5 h-3.5" />, color: "#7C3AED" },
  board:    { label: "Board Portal",  icon: <Shield className="w-3.5 h-3.5" />,        color: "#4F46E5" },
};
