      ...
      <div className="min-h-screen font-body bg-[#F5F3EF]">
        ...
        <div className="max-w-2xl mx-auto px-6 py-32 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Thank you for applying to the handlecraft.ai Fellowship. We'll review your application and be in touch soon. We're excited to learn more about you.
          </p>
          <Link href="/">
    ...
    <div className="min-h-screen font-body bg-[#F5F3EF]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-32">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="motivation">Why do you want to join the handlecraft.ai Fellowship? *</Label>
            <Textarea
              id="motivation"
              name="motivation"
              required
