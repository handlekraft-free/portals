...
function StudentDashboardContent() {
  ...
  return (
    <div>
      <div className="bg-gradient-to-r from-[#0F172A] to-purple-900 rounded-2xl p-6 mb-6 text-white">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          { icon: <Megaphone className="w-5 h-5 text-[#10B981]" />, label: "Announcements", value: loading ? "—" : announcements.length, bg: "bg-amber-50" },
          { icon: <FolderOpen className="w-5 h-5 text-[#2563EB]" />, label: "Files", value: "—", bg: "bg-teal-50" },
        ].map((s, i) => (
      ...
      <Card className="border-0 shadow-sm mb-4">
        <CardContent className="pt-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-[#0F172A]">My Courses</h3>
            <a href="/portal/student/courses" className="text-xs text-[#2563EB] hover:underline flex items-center gap-1">View all <ArrowRight className="w-3 h-3" /></a>
          </div>
      ...
      <Card className="border-0 shadow-sm">
        <CardContent className="pt-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-[#0F172A]">Recent Announcements</h3>
            <a href="/portal/student/announcements" className="text-xs text-[#2563EB] hover:underline flex items-center gap-1">View all <ArrowRight className="w-3 h-3" /></a>
          </div>
