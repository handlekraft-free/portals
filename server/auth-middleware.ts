...
export const requireEmployee = requireRole("admin", "employee", "manager");
export const requireClient = requireRole("client");
export const requireStudent = requireRole("student");
export const requireAdmin = requireRole("admin");
export const requireBoard = requireRole("admin", "board");
export const requireManager = requireRole("admin", "manager");
export const requireAnyPortalUser = requireRole("admin", "employee", "manager", "client", "student", "board");
